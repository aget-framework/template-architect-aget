...
### Added
- Archetype-specific skills: `aget-design-architecture`, `aget-assess-tradeoffs`
- Formal ontology: `ontology/ONTOLOGY_architect.yaml` (7 concepts, 2 clusters)
...
- README structure: "Why Architect?" value proposition

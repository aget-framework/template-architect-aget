...
This directory contains shell integration examples for the Architect template.
...
| File | Purpose |
|------|---------|
| `architect_profile.zsh` | Example zsh profile for architect agents |
...
source shell/architect_profile.zsh
```
...
1. Copy `architect_profile.zsh` to your instance
...
*Shell integration for template-architect-aget*

#!/bin/zsh
# ============================================================
# Architect Agent Shell Profile
# ============================================================
# Template: template-architect-aget
# Version: 3.3.0
#
# DOCUMENTATION
# -------------
# Shell README:    ./shell/README.md
# Template Spec:   ./specs/Architect_SPEC.md
# Template Vocab:  ./specs/Architect_VOCABULARY.md
...
# 2. Source this file: source shell/architect_profile.zsh
...
# ============================================================
export AGET_AGENT_NAME="${AGET_AGENT_NAME:-template-architect-aget}"
export AGET_ARCHETYPE="architect"
...
# ============================================================
export AGET_SPEC="${AGET_AGENT_DIR}/specs/Architect_SPEC.md"
export AGET_VOCAB="${AGET_AGENT_DIR}/specs/Architect_VOCABULARY.md"
